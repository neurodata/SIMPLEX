...
The current draft is already uploaded to \href{https://arxiv.org/pdf/1609.05148.pdf}{arXiv}, and will be submitted this month. As the next step, we are investigating the required sample size for MGC to achieve perfect power, as an effort to better understand its mechanism and better apply the methodology to real data testing. 
